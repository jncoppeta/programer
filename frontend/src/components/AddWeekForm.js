...
const AddWeekForm = ({ onFormSubmit }) => {
      ...
      return (
        <div className="exercise-modal">
                <div className="row" id="add-exercise-form-input">
                    <div className="col" id="add-exercise-form-input">
                        <div className="relative h-10 w-full min-w-[200px]" id="add-exercise-form-input">
                            ...
                            placeholder=" "
                            onChange= {(e) => handleInputChange('numDay', e.target.value)}
                            />
                ...
                <div className="container text-center" id="edit-container">
                    <button className="flex px-3 py-2 bg-blue-400 text-white font-semibold rounded" id="edit-button" onClick={handleSubmit}>Add Week</button>
                </div>   
        </div>
      );
}
