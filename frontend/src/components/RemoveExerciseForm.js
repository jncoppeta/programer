...
const RemoveExerciseForm = ({ onFormSubmit }) => {
      ...
      return (
        <div className="exercise-modal">
                ...
                <div className="container text-center" id="edit-container">
                    <button className="flex px-3 py-2 bg-blue-400 text-white font-semibold rounded" id="edit-button" onClick={handleSubmit}>Remove</button>
                </div>   
        </div>
      );
}

export default RemoveExerciseForm;
